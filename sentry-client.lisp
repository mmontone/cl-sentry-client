                 ...
                 (loop for var in (trivial-backtrace::frame-vars frame)
                       do
                          (json:encode-object-member (princ-to-string (trivial-backtrace::var-name var))
                                                     ...
                                                     json-stream))))
             (json:encode-object-member "filename" (trivial-backtrace::frame-source-filename frame) json-stream)
             ;;(json:encode-object-member "lineno" (trivial-backtrace::frame-source-pos frame) json-stream)
             )))
    (let ((frames nil))
